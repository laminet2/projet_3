<?php 
    ...
    function find_all_exemplaire():array{
        $exemplaires=[["id"=>1,"date_enregistrement"=>"01/01/2020","etat"=>"neuf","ouvrage_id"=>1],
                    ...
                    ["id"=>3,"date_enregistrement"=>"20/05/2017","etat"=>"deteriore","ouvrage_id"=>1],
    ...
    function find_all_demande_de_pret():array{
            $demande_de_pret=[["id"=>1,"adherent_id"=>1,"exemplaire_id"=>1,"statut"=>"accepter","date_pret"=>""],//accepter mais pas encore passer a la bibliotheque
                              ["id"=>2,"adherent_id"=>5,"exemplaire_id"=>5,"statut"=>"accepter","date_pret"=>"25/11/2022"],//accepter et passer a la bibliotheque
                              ["id"=>3,"adherent_id"=>3,"exemplaire_id"=>4,"statut"=>"","date_pret"=>""],//en attente
                              ["id"=>4,"adherent_id"=>4,"exemplaire_id"=>3,"statut"=>"rejeter","date_pret"=>""],//rejeter
                              ["id"=>5,"adherent_id"=>2,"exemplaire_id"=>5,"statut"=>"accepter","date_pret"=>"20/11/2022"],//accepter et passer en bibliotheque
                              ["id"=>6,"adherent_id"=>6,"exemplaire_id"=>8,"statut"=>"accepter","date_pret"=>"20/11/2022"],//accepter et passer en bibliotheque
